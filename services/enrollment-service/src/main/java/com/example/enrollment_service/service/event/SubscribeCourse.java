...
import com.example.enrollment_service.model.CommitEvent;
import com.example.enrollment_service.model.ReserveSlotEvent;
import com.example.enrollment_service.model.RollBackEvent;
...
//                         Nếu là CourseRegistrationEvent, xử lý
                        if ("CommitChangeQuantitySlotEvent".equals(eventType)) {
